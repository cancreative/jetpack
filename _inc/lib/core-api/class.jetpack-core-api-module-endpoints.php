	...
	private function _process_onboarding( $data ) {
		...
		if ( $data['addContactForm'] ) {
			if ( Jetpack::is_module_active( 'contact-form' ) ) {
				$contact_page = '[contact-form][contact-field label="Name" type="name" required="true" /][contact-field label="Email" type="email" required="true" /][contact-field label="Website" type="url" /][contact-field label="Message" type="textarea" /][/contact-form]';
			} else {
